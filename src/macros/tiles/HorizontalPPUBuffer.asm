.macro HorizontalPPUBuffer LeftFlag
...
PhasePrepare:
    ...
    HorizontalPreparePhase LeftFlag
    JMP PhasePlayer
...
PhaseComplete:
    ...
    HorizontalCompletePhase LeftFlag
    JMP EndMacro

PhaseActive:

    HorizontalActivePhase LeftFlag
...
PhasePlayer:
    ...
    HorizontalPlayerPhase LeftFlag
